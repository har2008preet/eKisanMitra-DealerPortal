...
public class machRegis2 extends AppCompatActivity {
    Spinner Type;
    ...
    private void register() {
        pDialog = new ProgressDialog(machRegis2.this);
        pDialog.setMessage("Logging in ...");
        showDialog();
        String url="http://192.168.43.17/dealer_portal/regismach.php?Name="+Ename+
                "&State="+Estate+"&District="+Edistrict+"&Type="+Type.getSelectedItem().toString()+
                "&Mobile="+Emobile+"&Village="+Evilage+"&Add="+Eaddress+"&Web="+Eweb;
        Log.d("url=============","http://192.168.43.17/dealer_portal/regismach.php?Name="+Ename+
                "&State="+Estate+"&District="+Edistrict+"&Type="+Type.getSelectedItem().toString()+
                "&Mobile="+Emobile+"&Village="+Evilage+"&Add="+Eaddress+"&Web="+Eweb);
        StringRequest SpecialReq = new StringRequest(url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        Intent i = new Intent(machRegis2.this, MainActivity.class);
                        startActivity(i);
                        finish();
